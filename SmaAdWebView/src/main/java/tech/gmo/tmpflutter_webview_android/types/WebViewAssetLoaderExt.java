...
public class WebViewAssetLoaderExt implements Disposable {
  ...
  public static class PathHandlerExt implements WebViewAssetLoader.PathHandler, Disposable {
    ...
    public static final String METHOD_CHANNEL_NAME_PREFIX = "tech.gmo/tmpflutter_webview_custompathhandler_";
    ...
    public PathHandlerExt(@NonNull String id, @NonNull InAppWebViewFlutterPlugin plugin) {
      this.id = id;
      this.channelDelegate = new PathHandlerExtChannelDelegate(this);
    }
  ...
  public static class PathHandlerExtChannelDelegate {
    ...
    public PathHandlerExtChannelDelegate(@NonNull PathHandlerExt pathHandler) {
...
//      channel.invokeMethod("handle", obj, callback);
    ...
    public WebResourceResponseExt handle(String path) throws InterruptedException {
      ...
      Map<String, Object> obj = new HashMap<>();
      obj.put("path", path);
      return Util.invokeMethodAndWaitResult( "handle", obj, callback);
    }
