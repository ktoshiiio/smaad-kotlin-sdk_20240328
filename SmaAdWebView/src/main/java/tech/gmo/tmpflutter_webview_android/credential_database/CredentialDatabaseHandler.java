package tech.gmo.tmpflutter_webview_android.credential_database;
...
public class CredentialDatabaseHandler {
  ...
  public static final String METHOD_CHANNEL_NAME = "tech.gmo/tmpflutter_webview_credential_database";
