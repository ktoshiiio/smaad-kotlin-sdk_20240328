...
public interface InAppWebViewInterface {
  ...
  void stopLoading();
  boolean isLoading();
  void takeScreenshot(Map<String, Object> screenshotConfiguration);
  ...
  void postWebMessage(tech.gmo.tmpflutter_webview_android.types.WebMessage message, Uri targetOrigin, ValueCallback<String> callback) throws Exception;
