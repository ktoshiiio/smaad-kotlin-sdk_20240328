...
import tech.gmo.tmpflutter_webview_android.types.WebMessagePortCompatExt;
import tech.gmo.tmpflutter_webview_android.webview.InAppWebViewInterface;
import tech.gmo.tmpflutter_webview_android.types.WebMessagePort;
...
public class WebMessageChannel implements Disposable {
  ...
  public static final String METHOD_CHANNEL_NAME_PREFIX = "tech.gmo/tmpflutter_webview_web_message_channel_";
  ...
  public WebMessageChannel(@NonNull String id, @NonNull InAppWebViewInterface webView) {
    this.id = id;
    this.channelDelegate = new WebMessageChannelChannelDelegate(this);
  ...
  public void setWebMessageCallbackForInAppWebView(final int index) {
...
//      result.success(true);
  ...
  public void postMessageForInAppWebView(final Integer index, @NonNull WebMessageCompatExt message) {
    if (webView != null && compatPorts.size() > 0 &&
...
//      result.success(true);
  ...
  public void closeForInAppWebView(Integer index) {
    if (webView != null && compatPorts.size() > 0 &&
