...
import tech.gmo.tmpflutter_webview_android.credential_database.CredentialDatabase;
...
import tech.gmo.tmpflutter_webview_android.types.URLCredential;
import tech.gmo.tmpflutter_webview_android.types.URLProtectionSpace;
...
//      }
  ...
  public void onSafeBrowsingHit(@NonNull final WebView view,
    ...
    final WebViewChannelDelegate.SafeBrowsingHitCallback resultCallback = new WebViewChannelDelegate.SafeBrowsingHitCallback() {
      @Override
      public boolean nonNullSuccess(@NonNull tech.gmo.tmpflutter_webview_android.types.SafeBrowsingResponse response) {
        Integer action = response.getAction();
        if (action != null) {
      ...
      @Override
      public void defaultBehaviour(@Nullable tech.gmo.tmpflutter_webview_android.types.SafeBrowsingResponse result) {
