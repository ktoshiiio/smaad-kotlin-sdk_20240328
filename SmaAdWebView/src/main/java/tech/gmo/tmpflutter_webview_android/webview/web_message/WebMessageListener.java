...
import tech.gmo.tmpflutter_webview_android.types.UserScriptInjectionTime;
...
public class WebMessageListener implements Disposable {
  ...
  public static final String METHOD_CHANNEL_NAME_PREFIX = "tech.gmo/tmpflutter_webview_web_message_listener_";
  ...
  @Nullable
  public static WebMessageListener fromMap(@NonNull InAppWebViewInterface webView, @Nullable Map<String, Object> map) {
    if (map == null) {
      return null;
    }
    ...
    return new WebMessageListener(id, webView, jsObjectName, allowedOriginRules);
  }
  ...
  public void postMessageForInAppWebView(WebMessageCompatExt message) {
