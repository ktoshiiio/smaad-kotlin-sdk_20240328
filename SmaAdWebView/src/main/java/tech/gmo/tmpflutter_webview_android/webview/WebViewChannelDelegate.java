...
import tech.gmo.tmpflutter_webview_android.find_interaction.FindInteractionChannelDelegate;
import tech.gmo.tmpflutter_webview_android.types.BaseCallbackResultImpl;
import tech.gmo.tmpflutter_webview_android.types.ClientCertChallenge;
import tech.gmo.tmpflutter_webview_android.types.ClientCertResponse;
import tech.gmo.tmpflutter_webview_android.types.CreateWindowAction;
import tech.gmo.tmpflutter_webview_android.types.CustomSchemeResponse;
import tech.gmo.tmpflutter_webview_android.types.DownloadStartRequest;
import tech.gmo.tmpflutter_webview_android.types.GeolocationPermissionShowPromptResponse;
import tech.gmo.tmpflutter_webview_android.types.HitTestResult;
import tech.gmo.tmpflutter_webview_android.types.HttpAuthResponse;
import tech.gmo.tmpflutter_webview_android.types.HttpAuthenticationChallenge;
import tech.gmo.tmpflutter_webview_android.types.JsAlertResponse;
import tech.gmo.tmpflutter_webview_android.types.JsBeforeUnloadResponse;
import tech.gmo.tmpflutter_webview_android.types.JsConfirmResponse;
import tech.gmo.tmpflutter_webview_android.types.JsPromptResponse;
import tech.gmo.tmpflutter_webview_android.types.NavigationAction;
import tech.gmo.tmpflutter_webview_android.types.NavigationActionPolicy;
import tech.gmo.tmpflutter_webview_android.types.PermissionResponse;
import tech.gmo.tmpflutter_webview_android.types.SafeBrowsingResponse;
import tech.gmo.tmpflutter_webview_android.types.ServerTrustAuthResponse;
import tech.gmo.tmpflutter_webview_android.types.ServerTrustChallenge;
import tech.gmo.tmpflutter_webview_android.types.SyncBaseCallbackResultImpl;
import tech.gmo.tmpflutter_webview_android.types.WebResourceErrorExt;
...
public class WebViewChannelDelegate {
  ...
  public WebViewChannelDelegate(@NonNull InAppWebViewInterface webView) {
...
//    channel.invokeMethod("onLoadResourceWithCustomScheme", obj, callback);
  ...
  public CustomSchemeResponse onLoadResourceWithCustomScheme(WebResourceRequestExt request) throws InterruptedException {
    ...
    return Util.invokeMethodAndWaitResult( "onLoadResourceWithCustomScheme", obj, callback);
  }
...
//    channel.invokeMethod("shouldInterceptRequest", request.toMap(), callback);
  ...
  public WebResourceResponseExt shouldInterceptRequest(WebResourceRequestExt request) throws InterruptedException {
    ...
    return Util.invokeMethodAndWaitResult( "shouldInterceptRequest", request.toMap(), callback);
  }
