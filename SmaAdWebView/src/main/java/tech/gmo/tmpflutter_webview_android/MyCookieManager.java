...
public class MyCookieManager {
  ...
  public static final String METHOD_CHANNEL_NAME = "tech.gmo/tmpflutter_webview_cookiemanager";
  @Nullable
...
//      result.success(true);
  ...
  public void deleteCookies(String url, String domain, String path) {
    cookieManager = getCookieManager();
    if (cookieManager == null) return;
